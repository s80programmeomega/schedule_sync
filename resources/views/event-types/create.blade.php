          ...
          <div class="card-body p-4">
            <form method="POST" action="{{ route('event-types.store') }}">
              ...
              <div class="row mb-4">
                ...
                {{-- Add to existing event-types/create.blade.php after event type fields --}}
                ...
                @if (auth()->user()->teams->isNotEmpty())
                  <div class="mb-4">
                    ...
                    <select class="form-select @error('team_id') is-invalid @enderror" id="team_id" name="team_id">
                      <option value="">Personal Event Type</option>
                  ...
                  <div class="mb-4" id="team-settings" style="display: none;">
                    <div class="card border">
                      <div class="card-header">
                        <h6 class="mb-0">Team Event Settings</h6>
                      </div>
                      <div class="card-body">
                        <div class="form-check mb-3">
                          ...
                          <label class="form-check-label" for="is_team_event">
                            Multiple team members can host this event
                          </label>
                        </div>

                        <div class="form-check mb-3">
                          <input class="form-check-input" type="checkbox" id="allow_multiple_attendees"
                            name="allow_multiple_attendees" value="1">
                          <label class="form-check-label" for="allow_multiple_attendees">
                            Allow multiple attendees per booking
                          </label>
                        </div>
                  ...
                  <script>
                    document.getElementById('team_id').addEventListener('change', function() {
                      ...
                      teamSettings.style.display = this.value ? 'block' : 'none';
                    });
                  </script>
                @endif
              ...
              <div class="mb-4">
                ...
                <select class="form-select @error('location_type') is-invalid @enderror" id="location_type"
                  ...
                  <option value="google_meet" {{ old('location_type') == 'google_meet' ? 'selected' : '' }}>Google Meet
                  </option>
              ...
              <div class="row mb-4">
                <div class="col-md-6">
                  ...
                  <input type="number" class="form-control @error('buffer_time_before') is-invalid @enderror"
                    id="buffer_time_before" name="buffer_time_before" value="{{ old('buffer_time_before', 0) }}"
                    min="0" max="60">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" class="form-control @error('buffer_time_after') is-invalid @enderror"
                    id="buffer_time_after" name="buffer_time_after" value="{{ old('buffer_time_after', 0) }}"
                    min="0" max="60">
              ...
              <div class="mb-4">
                ...
                <input type="number" class="form-control @error('max_events_per_day') is-invalid @enderror"
                  id="max_events_per_day" name="max_events_per_day" value="{{ old('max_events_per_day') }}"
                  min="1" max="20">
              ...
              <div class="form-check mb-4">
                <input class="form-check-input" type="checkbox" id="requires_confirmation"
                  name="requires_confirmation" value="1" {{ old('requires_confirmation') ? 'checked' : '' }}>
