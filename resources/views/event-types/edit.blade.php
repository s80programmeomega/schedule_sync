                        ...
                        <form method="POST" action="{{ route('event-types.update', $eventType) }}">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('duration') is-invalid @enderror" id="duration"
                                        ...
                                        <option value="15"
                                            {{ old('duration', $eventType->duration) == '15' ? 'selected' : '' }}>15 minutes
                                        </option>
                                        <option value="30"
                                            {{ old('duration', $eventType->duration) == '30' ? 'selected' : '' }}>30 minutes
                                        </option>
                                        <option value="45"
                                            {{ old('duration', $eventType->duration) == '45' ? 'selected' : '' }}>45 minutes
                                        </option>
                                        <option value="60"
                                            {{ old('duration', $eventType->duration) == '60' ? 'selected' : '' }}>1 hour
                                        </option>
                                        <option value="90"
                                            {{ old('duration', $eventType->duration) == '90' ? 'selected' : '' }}>1.5 hours
                                        </option>
                                        <option value="120"
                                            {{ old('duration', $eventType->duration) == '120' ? 'selected' : '' }}>2 hours
                                        </option>
                                    </select>
                                    @error('duration')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                {{-- <div class="col-md-6">
                                    ...
                                    <input type="color"
                                        ...
                                        id="color" name="color"
                                        value="{{ old('color', $eventType->color ?? '#6366f1') }}">
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div> --}}
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex gap-2 mb-2">
                                        @foreach (\App\Models\EventType::getDefaultColors() as $defaultColor)
                                            <div class="color-option"
                                                style="background-color: {{ $defaultColor }}; width: 30px; height: 30px; border-radius: 4px; cursor: pointer;"
                                                onclick="document.getElementById('color').value='{{ $defaultColor }}'">
                                            </div>
                                        @endforeach
                                    </div>
                                    <input type="color" class="form-control form-control-color" id="color"
                                        name="color" value="{{ old('color', $eventType->color ?? '#5D5CDE') }}">
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('location_type') is-invalid @enderror" id="location_type"
                                    ...
                                    @foreach (\App\Models\EventType::getLocationTypes() as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('location_type', $eventType->location_type) == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('location_details') is-invalid @enderror"
                                    ...
                                    value="{{ old('location_details', $eventType->location_details) }}"
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('buffer_time_before', $eventType->buffer_time_before ?? 0) }}"
                                        min="0" max="60">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('buffer_time_after', $eventType->buffer_time_after ?? 0) }}"
                                        min="0" max="60">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('max_events_per_day', $eventType->max_events_per_day) }}"
                                    min="1" max="20">
                            ...
                            <div class="form-check mb-4">
                                ...
                                <input class="form-check-input" type="checkbox" id="requires_confirmation"
                                    ...
                                    {{ old('requires_confirmation', $eventType->requires_confirmation) ? 'checked' : '' }}>
