            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <div class="card-header">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            @if(Auth::user()->avatar)
                            <img src="{{ \Illuminate\Support\Facades\Storage::url(Auth::user()->avatar) }}" alt="Avatar"
                                class="rounded-circle img-fluid img-responsive" min-width="64" min-height="64">
                            @else
                ...
                <div class="mb-3">
                    ...
                    <select name="timezone_id" class="form-select @error('timezone_id') is-invalid @enderror" required>
                        ...
                        <option value="{{ $timezone->id }}" {{ old('timezone_id', auth()->user()->timezone_id) ==
                            $timezone->id ? 'selected' : '' }}>
