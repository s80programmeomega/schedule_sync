            ...
            <div class="card">
                <div class="card-body text-center">
                    @if($booking->isPendingApproval())
                        ...
                        <p class="mb-4">Your booking request has been submitted and is pending approval. You'll receive an email once it's reviewed.</p>
                    @else
                    ...
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <p class="mb-1"><strong>Time:</strong> {{ Carbon\Carbon::parse($booking->start_time)->format('g:i A') }}</p>
