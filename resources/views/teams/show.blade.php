...
@section('content')
    <div class="col-lg-10 col-12 py-4 px-4 px-lg-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    @endcan
                    <li><a class="dropdown-item" href="{{ route('contacts.index', ['team_id' => $team->id]) }}">Team
                            Contacts</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3">
                <a href="{{ route('event-types.index') }}" class="text-decoration-none">
                    <div class="card border-0 shadow-sm h-100 hover-card">
                        <div class="card-body text-center">
            ...
            <div class="col-md-3 mb-3">
                <a href="{{ route('contacts.index', ['team_id' => $team->id]) }}" class="text-decoration-none">
                    <div class="card border-0 shadow-sm h-100 hover-card">
                        <div class="card-body text-center">
                ...
                @forelse($team->eventTypes->take(3) as $eventType)
                    <div class="d-flex align-items-center mb-3">
                        <div class="event-type-icon me-3"
                            style="background-color: {{ $eventType->color }}20; color: {{ $eventType->color }}">
                            <i class="bi bi-calendar-event"></i>
                        </div>
                        <div class="flex-grow-1">
                            <h6 class="mb-0">{{ $eventType->name }}</h6>
                            <small class="text-muted">{{ $eventType->duration }} min • {{ $eventType->bookings_count }}
                                bookings</small>
                        </div>
